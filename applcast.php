...
<!-------33333333333333333333-thsese the main-333333333333333333333333333333333333333333333333---->
<h2>
  <label> CASTE CERTIFICATE APPLICATION FORM</label>
</h2>
<div class="apply"></div>
<form action="dbcaste.php" method="post">
  <table align="center">
    <tr>
      <td>
